...
def populate():
    ...
    hotel_pages = [
		...
		"city":"Glasgow",
		"picture":"/hotel_images/happy_puppy.jpg",
		"phone_number":02345678912,
		...
		"city":"Glasgow",
		"picture":"/hotel_images/little_paw.jpg",
		"phone_number":02345678912,
		...
		"city":"London",
		"picture":"/hotel_images/chateau_du_chien.jpg",
		"phone_number":02345678912,
    ...
    sitter_pages = [
        ...
        {"name":"Inna Green",
		 "age":23,
		 "picture":"/sitter_images/inna_green.jpg",
		 ...
		 "phone number":02345678912,
		 "price_pounds":20,
		 "city":"London",
		 },
		{"name":"Zoe Jones",
		 "age":32,
		 "picture":"/sitter_images/zoe_jones.jpg",
		 ...
		 {"name":"John Wilson",
		 "age":65,
		 "picture":"/sitter_images/john_wilson.jpg",
...
def add_sitter_page( name.split(), age, picture, bio, dog_preference, availability, phone_number, price_pounds, city):
